...
* In the file_path line of extract_a2F_lambda.py, you need to paste the path of a2F.dos*, and here '* = 1, 2,3 ...10' which is choosen in which number your degauss value lies in lambda.out counting from top
