...
* Inside extract_a2F_lambda.py, in the file_path line,  you need to paste the path of a2F.dos10, and a2F.dos10 is chosen using the converged value of Tc calculated from lambda.in which is shown in lambda.out otherwise you need to take other a2F.dos*
